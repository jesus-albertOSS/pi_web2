  ...
  const rewards = [
    ...
    },
    {
      ...
      details: {
        ...
        example: "Compra por $50.000 COP = 50 puntos. Al llegar a 100 puntos, obtén $5.000 COP de descuento"
      }
    },
    {
      ...
      details: {
        ...
        example: "Esta semana: FIFA 25 con 40% de descuento, de $180.000 a $108.000 COP"
      }
    },
    {
